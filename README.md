...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .skill-card:hover { border-color: var(--green); background: rgba(0,255,106,.03); transform: translateY(-2px); }
  ...
  .tl-card:hover { border-color: var(--green2); }
  .tl-date {
    font-size: 11px;
    color: var(--amber);
    letter-spacing: 2px;
  ...
  .proj-card:hover { border-color: var(--cyan2); transform: translateY(-3px); }
  ...
  .proj-card:hover .proj-num { color: rgba(0,229,255,.15); }
  .proj-title {
    font-family: var(--font-ui);
    font-size: 16px;
    font-weight: 700;
  ...
  .contact-link-item:hover { border-color: var(--green2); color: var(--green); }
...
<div id="bios">
  ...
  <div class="bios-line" id="b2" style="margin-top:16px;">CPU: <span class="bios-green">NKS 
